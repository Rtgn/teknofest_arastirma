...
Kartesyen aday sayısını düşürmek için `outputs/runtime/ewc_nace_map.csv` (veya `.xlsx`) kullanılır: `ewc_code`, `nace_code` sütunları. Şablon: `data_schemas/templates/ewc_nace_map_template.csv`.
